package au.com.katalyst.kelpie.utils
{
  ...
  public class Input
  {
    ...
    {
      return _displayObject.stage.mouseX;
    }
    ...
    {
      return _displayObject.stage.mouseY;
    }
    ...
    public static function enable(displayObject:DisplayObject):void
    {
      ...
      {
        displayObject.stage.addEventListener(KeyboardEvent.KEY_DOWN, onKeyDown);
        displayObject.stage.addEventListener(KeyboardEvent.KEY_UP, onKeyUp);
        displayObject.stage.addEventListener(MouseEvent.MOUSE_DOWN, onMouseDown);
        displayObject.stage.addEventListener(MouseEvent.MOUSE_UP, onMouseUp);
        displayObject.stage.addEventListener(MouseEvent.MOUSE_WHEEL, onMouseWheel);
        displayObject.stage.addEventListener(MouseEvent.MOUSE_MOVE, onMouseMove);
    ...
    private static function onMouseMove(e:MouseEvent):void
    {
      ...
      _displayObject.stage.removeEventListener(MouseEvent.MOUSE_MOVE, onMouseMove);
    }
    ...
    // Input information.
    /** @private */ private static var _displayObject:DisplayObject = null;
